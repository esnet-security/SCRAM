...
.Phony: copy-libs
copy-libs:
	@docker compose cp translator:/app/gobgp_pb2.py /tmp/
	@docker compose cp translator:/app/gobgp_pb2.pyi /tmp/
	@docker compose cp translator:/app/gobgp_pb2_grpc.py /tmp/
	@docker compose cp translator:/app/attribute_pb2.py /tmp/
	@docker compose cp translator:/app/attribute_pb2.pyi /tmp/
	@docker compose cp translator:/app/attribute_pb2_grpc.py /tmp/
	@docker compose cp translator:/app/capability_pb2.py /tmp/
	@docker compose cp translator:/app/capability_pb2.pyi /tmp/
	@docker compose cp translator:/app/capability_pb2_grpc.py /tmp/
	cp /tmp/*.py /tmp/*.pyi translator
